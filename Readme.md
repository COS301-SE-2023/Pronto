 ...
 <p align = "center" >Download ExpoGo from the <a href="https://itunes.apple.com/app/apple-store/id982107779">App store</a> on IOS, or get it from <a href="https://play.google.com/store/apps/details?id=host.exp.exponent&referrer=www">Google Play</a> if you are on Android. After downloading the ExpoGo app, scan the QR code in ExpoGo to use the student mobile application. </p>
  ...
  <tr>
    ...
    <td align: "center">
      ...
      <img src="Documentation/ReadME Resources/Images/IOSQR.png" alt="QR code 2" title="QR 2" style="width: 170px; margin: 10px;">
    </td>
  </tr>
</table>
