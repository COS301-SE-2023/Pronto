...
describe('NotificationList', () => {
    ...
    test('expands and collapses Reminders accordion', () => {
        ...
        expect(getByText('COS 301: Lecture venue changed from North Hall to IT 2-27')).toBeTruthy();
        fireEvent.press(getByText('Reminders'));
        expect(() => getByText('COS 301: Lecture venue changed from North Hall to IT 2-27')).toThrow();
    });
    ...
    test('expands and collapses Other accordion', () => {
        ...
        expect(getByText('IMY310: Remeber your pens for the semester test')).toBeTruthy();
        fireEvent.press(getByText('Other'));
        expect(() => getByText('IMY310: Remeber your pens for the semester test')).toThrow();
    });
