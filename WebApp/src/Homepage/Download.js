    ...
    return (
        <div id="downloadSection" className='download-container'>
            ...
            <div className='instructions-container'>
                ...
                <p>Step 1: Download the ExpoGo app from the <a href="https://itunes.apple.com/app/apple-store/id982107779">App store</a> on IOS, or get it from <a href="https://play.google.com/store/apps/details?id=host.exp.exponent&referrer=www">Google Play</a> if you are on Android.</p>
