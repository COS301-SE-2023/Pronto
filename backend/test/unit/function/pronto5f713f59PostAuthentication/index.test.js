...
const moduleIterator = require("../../../../amplify/backend/function/pronto5f713f59PostAuthentication/src/index");
...
describe("testing module iterator", () => {
  ...
  beforeEach(() => {
    ...
    jest.mock(
      "../../../../amplify/backend/function/pronto5f713f59PostAuthentication/src/index",
      () => ({
  ...
  test("should return the event", async () => {
    const mockmoduleIterator = require("../../../../amplify/backend/function/pronto5f713f59PostAuthentication/src/index");
