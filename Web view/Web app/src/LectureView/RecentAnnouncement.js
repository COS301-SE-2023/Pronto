...
export default function RecentAnnouncement() {
    ...
    return (
        <div style={{ display: 'inline-flex' }}>
            <nav style={{ width: '20%' }} data-testid="institution-navigation">
            ...
            <main style={{ width: '900px', marginTop: '30px' }}>
                ...
                <div className="card" data-testid="announcement-card1">
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">
                            Please note that due to the completion of the syllabus in this morning's lecture, there will be no class tomorrow or from here forth:)
                        </p>
                ...
                <div className="card" data-testid="announcement-card2">
                    <div className="card-header">
