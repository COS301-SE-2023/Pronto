...
import { updateInstitution } from "../src/graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function InstitutionUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPageUrl(cleanValues.pageUrl);
    setCampusMapUrl(cleanValues.campusMapUrl);
    setOpeningTime(cleanValues.openingTime);
    setClosingTime(cleanValues.closingTime);
    setMinimumDuration(cleanValues.minimumDuration);
    setLectureremails(cleanValues.lectureremails ?? []);
    setCurrentLectureremailsValue("");
    setCoursecodes(cleanValues.coursecodes ?? []);
    setCurrentCoursecodesValue("");
    setLogo(cleanValues.logo);
    setDomains(cleanValues.domains ?? []);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          campusMapUrl: campusMapUrl ?? null,
          openingTime: openingTime ?? null,
          closingTime: closingTime ?? null,
          minimumDuration: minimumDuration ?? null,
          lectureremails: lectureremails ?? null,
