...
const awsmobile = {
  ...
  aws_cognito_username_attributes: [
    process.env.REACT_APP_aws_cognito_verification_mechanisms_0,
  ],
  aws_cognito_social_providers: [],
  aws_cognito_signup_attributes: [
    process.env.REACT_APP_aws_cognito_verification_mechanisms_0,
    process.env.REACT_APP_FAMILY_NAME,
    process.env.REACT_APP_GIVEN_NAME,
  ],
  ...
  aws_cognito_password_protection_settings: {
    ...
    passwordPolicyCharacters: [
      process.env
        .REACT_APP_aws_cognito_password_protection_settings_passwordPolicyCharacters_0,
      process.env
        .REACT_APP_aws_cognito_password_protection_settings_passwordPolicyCharacters_1,
      process.env
        .REACT_APP_aws_cognito_password_protection_settings_passwordPolicyCharacters_2,
      process.env
        .REACT_APP_aws_cognito_password_protection_settings_passwordPolicyCharacters_3,
    ],
  },
